...
class_name = input("Which class you are here for? ")
...
If yes, print "It's even" Otherwise, print "It's not even."
Use if-else statement.
...
if player2_choice == "Rock": # if player1_choice == player2_choice:
    print("It's a tie!")
else: # Player2 could be "Paper" or "Scissors"
    if player2_choice == "Scissors":
        print("Player 1 wins! Rock crushes Scissors!")
    else: # player2_choice == "Paper"
